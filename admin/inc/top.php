...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="../inc/images/favicon.svg" type="image/x-icon" />
    <title>Admin-Nền tảng mua bán đồ cũ</title>
    <!-- ========== All CSS files linkup ========= -->
    <link rel="stylesheet" href="../inc/css/bootstrap.min.css" />
    <link rel="stylesheet" href="../inc/css/lineicons.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="../inc/css/materialdesignicons.min.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="../inc/css/fullcalendar.css" />
    <link rel="stylesheet" href="../inc/css/fullcalendar.css" />
        ...
        <ul>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_1" class="collapse show dropdown-nav">
              <li>
                <a href="../ktnguoidung/index.php" class="active"> Bảng điều khiển </a>
              </li>
              <?php if(isset($_SESSION["nguoidung"]) && $_SESSION["nguoidung"]["vaitro"]==1){ ?>
              <li>
                <a href="../qlnguoidung/index.php" class="active"> Quản lí người dùng </a>
              </li>
              <?php } ?>
            </ul>
          </li>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_2" class="collapse dropdown-nav">
              <li class="<?php if(strpos($_SERVER['REQUEST_URI'],"qldanhmuc") != false) echo "active"; ?>">
                <a href="../qldanhmuc/index.php"> Quản lí danh mục </a>
              </li>
              <li class="<?php if(strpos($_SERVER['REQUEST_URI'],"qlmathang") != false) echo "active"; ?>">
                <a href="../qlmathang/index.php"> Quản lí mặt hàng </a>
              </li>
            </ul>
          </li>
          <?php if(isset($_SESSION["nguoidung"]) && $_SESSION["nguoidung"]["vaitro"]==1){ ?>
          ...
          <li class="nav-item">
            ...
            >
              ...
              <span class="text">Quản lí doanh thu </span>
            </a>
          </li>
          <?php if(isset($_SESSION["nguoidung"]) && $_SESSION["nguoidung"]["vaitro"]==1){ ?>
          <li class="nav-item">
            <a
              href="../qldonhang/index.php"
              class="collapsed"
              data-bs-toggle="collapse"
              data-bs-target=""
              aria-controls=""
          ...
          <li class="nav-item">
            ...
            >
              ...
              <span class="text"> Quản lí khuyến mãi</span>
            </a>
          </li>
          <li class="nav-item nav-item-has-children">
            <a
            ...
            >
              ...
              <span class="text">Cấu hình website</span>
            </a>
          ...
          <div class="row">
            ...
            <div class="col-lg-7 col-md-7 col-6">
              <div class="header-right">
                <!-- notification start -->
                <div class="header-massage-box ml-15 d-none d-md-flex">
                  <button class="dropdown-toggle" type="button" id="header" data-bs-toggle="dropdown"
                    aria-expanded="false">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="message">
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="../../image/users/user.png" alt="" />
                        </div>
                        <div class="content">
                          <h6>Lương Ngọc Thanh</h6>
                          <p>Sản phẩm của bạn rất tốt</p>
                          <p>30 phút trước</p>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="../../image/users/conan1.jpg" alt="" />
                        </div>
                        <div class="content">
                          <h6>Lý Công Hội</h6>
                          <p>Sản phẩm của bạn rất tốt</p>
                    ...
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="../../image/users/messi.jpg" alt="" />
                        </div>
                        <div class="content">
                          <h6>Ngô Huy Phúc</h6>
                          <p>Sản phẩm đúng với sản phẩm quản cáo</p>
                          <p>15 phút trước</p>
                        </div>
                      </a>
                    </li>
                ...
                <div class="profile-box ml-15">
                  <button class="dropdown-toggle bg-transparent border-0" type="button" id="profile"
                    ...
                    <div class="profile-info">
                      <div class="info">
                        <div class="image">
                          <img src="<?php if ($_SESSION["nguoidung"]["hinhanh"]==NULL) echo "../../image/users/user.png"; else echo "../../image/users/" . $_SESSION["nguoidung"]["hinhanh"]; ?>" alt="" />                                         
                        </div>
                        <div>
                          <h6 class="fw-500">Chào <?php if(isset($_SESSION["nguoidung"])) echo $_SESSION["nguoidung"]["hoten"]; else echo "bạn"; ?></h6>
                        </div>
                      </div>
                    </div>
                  </button>
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                    <li>
                      <div class="author-info flex items-center !p-1">
                        <div class="image">
                          <img src="<?php if ($_SESSION["nguoidung"]["hinhanh"]==NULL) echo "../../image/users/user.png"; else echo "../../image/users/" . $_SESSION["nguoidung"]["hinhanh"]; ?>" alt="image">
                        </div>
                        <div class="content">
                          <h4 class="text-sm">Chào <?php if(isset($_SESSION["nguoidung"])) echo $_SESSION["nguoidung"]["hoten"]; else echo "bạn"; ?></h4>
                          <a class="text-black/40 dark:text-white/40 hover:text-black dark:hover:text-white text-xs" href="#"><?php if(isset($_SESSION["nguoidung"])) echo $_SESSION["nguoidung"]["email"]; else echo ""; ?></a>
                        </div>
                      </div>
                    </li>
                    <li class="divider"></li>
                    <li>
                      <a href="../ktnguoidung/index.php?action=hoso"><i class="lni lni-user"></i> Hồ sơ cá nhân 
                      </a>
                    </li>
                    <li>
                      <a href="../ktnguoidung/index.php?action=matkhau""><i class="lni lni-cog"></i> Đổi mật khẩu </a>
                    </li>
                    <li>
                      <a href="../ktnguoidung/index.php?action=dangxuat"><i class="lni lni-exit"></i> Đăng xuất </a>
                    </li>
                  </ul>
                </div>
                <!-- profile end -->
